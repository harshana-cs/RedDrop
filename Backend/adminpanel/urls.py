...
from .views import (
    ...
    # Analytics
    analytics_kpi,
    analytics_donation_trends,
    analytics_demand_supply,
    analytics_hospital_performance,
...
urlpatterns = [
    ...
    # ── Overview chart endpoints ───────────────────────────────
    path("analytics/blood-types/",                     api_blood_type_distribution),
    path("analytics/request-status/",                  api_request_status_overview),

    # ── Analytics dashboard endpoints ─────────────────────────
    path("analytics/kpi/",                             analytics_kpi),
    path("analytics/donation-trends/",                 analytics_donation_trends),
    path("analytics/demand-supply/",                   analytics_demand_supply),
    path("analytics/hospital-performance/",            analytics_hospital_performance),
    path("analytics/donor-activity/",                  analytics_donor_activity),
    path("analytics/fulfillment/",                     analytics_fulfillment),
    path("analytics/geographic/",                      analytics_geographic),

    # ── Notifications ──────────────────────────────────────────
    # IMPORTANT: mark-all-read must come BEFORE <int:id> route
